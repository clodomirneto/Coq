...
Inductive seq : list Formula -> Formula -> Prop :=
| seq_ax : forall p Gamma,  (In p Gamma ) ->  Gamma |- p
| seq_con_l : forall Gamma A B G, (A :: B :: Gamma |- G) -> (A /\ B :: Gamma |- G)
| .........
.
...
Theorem Ex1: seq(a /\ b ,b /\ a) .
apply seq_con_l . ==> seq(a /\ b ,b /\ a) .
Goal: seq( [a,b] ,b /\ a) .
apply seq_con_r
Goal1: seq([a,b] , a])
apply seq_ax
